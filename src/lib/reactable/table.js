    ...
    _createClass(Table, [{
        ...
        value: function initializeSorts() {
            ...
            for (let i in this.props.sortable) {
                ...
                currentSort.sortType = column.sortType;
        ...
        value: function getCurrentSort(column) {
            ...
            if (column instanceof Object) {
                column.sortType = this.props.sortType;
                if (typeof column.column !== 'undefined') {
                    columnName = column.column;
                } else {
        ...
        value: function sortByCurrentSort() {
            ...
            if (currentSort.column === null || currentSort.sortType === 'async') {
                return;
            }
        ...
        value: function render() {
            ...
            var currentChildrenStart = currentPage * itemsPerPage + 1;
            if (currentChildrenStart < 0) {
                currentChildrenStart = 0;
            }
            var currentChildrenEnd = (currentPage + 1) * itemsPerPage;
            if (currentChildrenEnd > filteredChildren.length) currentChildrenEnd = filteredChildren.length;
            ...
            //currentPage:{currentPage} numPages:{numPages} pageStart:{currentPage * itemsPerPage} pageEnd:{(currentPage + 1) * itemsPerPage} currentChildren:{currentChildren.length} filteredChildren:{filteredChildren.length}
            return _react2['default'].createElement(
                'div',
                null,
                this.props.showMoreInfo && _react2['default'].createElement(
                    'h4',
                    null,
                    'Showing ',
                    currentChildrenStart,
                    ' - ',
                    currentChildrenEnd,
                    ' of ',
